...
if __name__ == "__main__":
    ...
    ft = CNNText(max_nb_words=MAX_NB_WORDS, max_sequence_length=MAX_SEQUENCE_LENGTH, n_classes=n_classes, word_index=word_index, hidden_layer=HIDDEN_LAYER, lr=lr)
    model = ft.model
    model.summary()
